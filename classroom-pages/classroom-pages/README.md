...
- `slp-companion-leaders-decision-lab.html` - Companion exercise for sorting case evidence and choosing an option.
- `slp-companion/` - hosted copy of the existing SLP Companion build for GitHub Pages testing.
